...
- After EVERY interpretive claim, add a source tag in square brackets to indicate its basis:
  [R] = value or result computed by R (use for every p-value, CI, OR, RR, mean, SD, count, date)
  [WHO] = based on WHO guideline or internationally recognized threshold
  [CDC] = based on CDC/FETP standard, definition, or field epidemiology convention
  [EpiR] = based on EpiR Handbook guidance or methodology
  [DOH] = based on Philippine DOH circular, PIDSR standard, or national policy
  [stat] = general statistical convention (alpha=0.05, effect size thresholds, normality rules, etc.)
- Apply tags inline immediately after the value or claim they support
- Examples of correct tagging:
  "The attack rate among exposed individuals was 45.2% [R], compared to 12.1% [R] among unexposed (p=0.003 [R])."
  "A p-value below the conventional alpha of 0.05 [stat] indicates statistical significance."
  "Risk ratio of 2.4 [R] (95% CI: 1.8–3.1 [R]) exceeds 1.0, indicating elevated risk [WHO]."
  "The epidemic curve shows a point-source pattern [CDC] with peak cases on May 14, 2026 [R]."
  "According to DOH PIDSR standards [DOH], the case fatality rate of 3.2% [R] warrants immediate investigation."
  "Cohen's d of 0.6 [R] indicates a medium effect size [stat]."
- Do NOT add a separate References section — inline tags only
