...
export async function downloadReportAsPdf(
  ...
  const styles = StyleSheet.create({
    ...
    chartImage: { width: '100%', marginTop: 8, marginBottom: 8, borderRadius: 4 },
    chartCaption: { fontSize: 8, color: colors.gray, textAlign: 'center', fontFamily: 'Helvetica-Oblique', marginTop: 4 },
    // Footer
  ...
  const doc = (
    <Document title={`JOANResearchOS Report — ${testLabel}`} author="JOANResearchOS" creator="JOANResearchOS">
      <Page size="A4" style={styles.page} wrap>
        ...
        {/* Section 3: Statistical Chart (only if chart exists) */}
        {chartBase64 && typeof chartBase64 === 'string' && chartBase64.startsWith('data:image') && (
          <View style={styles.chartSection}>
            <Text style={styles.sectionTitle}>3. Statistical Chart</Text>
            <Text style={[styles.bodyText, { color: colors.gray, fontSize: 8.5, marginBottom: 6 }]}>
              Generated by R using ggplot2 after statistical analysis completed. Every axis value and data point reflects actual R output — not AI-estimated.
            </Text>
            <Image src={chartBase64} style={styles.chartImage} />
            <Text style={styles.chartCaption}>
              JOANResearchOS · Statistical chart generated by R · All values computed by R, not AI
            </Text>
          </View>
        )}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{chartBase64 ? '4' : '3'}. Results & Interpretation</Text>
        ...
        {/* Section 5: Raw R Output */}
        <View style={styles.section} wrap={false}>
          <Text style={styles.sectionTitle}>{chartBase64 ? '5' : '4'}. Raw R Output</Text>
          <Text style={[styles.bodyText, { color: colors.gray, fontSize: 8.5, marginBottom: 6 }]}>
        ...
        {/* Section 6: R Script */}
        <View style={styles.section} wrap={false}>
          <Text style={styles.sectionTitle}>{chartBase64 ? '6' : '5'}. R Script (Reproducible Code)</Text>
          <Text style={[styles.bodyText, { color: colors.gray, fontSize: 8.5, marginBottom: 6 }]}>
