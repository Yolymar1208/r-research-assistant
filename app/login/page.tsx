        ...
        <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '32px' }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ textAlign: 'right', marginBottom: '20px' }}>
              <button type="button" onClick={handleForgotPassword} style={{ background: 'none', border: 'none', color: '#2e75b6', fontSize: '13px', cursor: 'pointer', padding: 0 }}>
                Forgot password?
              </button>
            </div>
            ...
            {message && (
              <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '10px 12px', fontSize: '13px', color: '#166534', marginBottom: '16px' }}>
                {message}
              </div>
            )}
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#666' }}>
            No account?{' '}
            <a href="/register" style={{ color: '#2e75b6', fontWeight: 600, textDecoration: 'none' }}>Create one free</a>
          </p>
        </div>
