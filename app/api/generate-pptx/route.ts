...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const shapes = (pres as any).shapes
    ...
    if (chartBase64) {
      ...
      s2.addShape(shapes.RECTANGLE, { x: 0, y: 0, w: 10, h: 0.06, fill: { color: C.violet }, line: { color: C.violet } })
      ...
      s2.addShape(shapes.RECTANGLE, { x: 0, y: 5.575, w: 10, h: 0.05, fill: { color: C.violet }, line: { color: C.violet } })
    ...
    s3.addShape(shapes.RECTANGLE, { x: 0, y: 0, w: 10, h: 0.06, fill: { color: C.gold }, line: { color: C.gold } })
    ...
    if (summarySection) {
      ...
      s3.addShape(shapes.ROUNDED_RECTANGLE, {
    ...
    s3.addShape(shapes.RECTANGLE, { x: 0, y: 5.575, w: 10, h: 0.05, fill: { color: C.gold }, line: { color: C.gold } })
    ...
    s4.addShape(shapes.RECTANGLE, { x: 0, y: 0, w: 10, h: 0.06, fill: { color: C.violet }, line: { color: C.violet } })
    ...
    // Divider
    s4.addShape(shapes.LINE, { x: 5.0, y: 0.9, w: 0, h: 4.2, line: { color: 'D1D5DB', width: 1 } })

    s4.addShape(shapes.RECTANGLE, { x: 0, y: 5.575, w: 10, h: 0.05, fill: { color: C.violet }, line: { color: C.violet } })
    ...
    if (recommendations.length > 0) {
      ...
      s5.addShape(shapes.RECTANGLE, { x: 0, y: 0, w: 10, h: 0.06, fill: { color: C.green }, line: { color: C.green } })
      ...
      recommendations.forEach((rec, i) => {
        ...
        s5.addShape(shapes.ROUNDED_RECTANGLE, {
      ...
      s5.addShape(shapes.RECTANGLE, { x: 0, y: 5.575, w: 10, h: 0.05, fill: { color: C.green }, line: { color: C.green } })
    ...
    s6.addShape(shapes.RECTANGLE, { x: 0, y: 0, w: 10, h: 0.06, fill: { color: C.blue }, line: { color: C.blue } })
    ...
    refItems.forEach(ref => {
      s6.addShape(shapes.ROUNDED_RECTANGLE, {
    ...
    s6.addShape(shapes.RECTANGLE, { x: 0, y: 5.575, w: 10, h: 0.05, fill: { color: C.blue }, line: { color: C.blue } })
